...
########################################################################
# Extension Manager/Repository config file for ext "gentleblog".
#
...
$EM_CONF[$_EXTKEY] = array(
	'title'         => 'multiblog',
	'description'   => 'A blog extension for typo3: Complete Frontend Editing of Blogentries, including blog widgets and comment system, multiple blogs in one installation possible. Easy to install and administration. Responsive Design, works perfectly with the extension responsive_template. TYPO3 4.7 or 6.1 required.',
	'category'      => 'plugin',
	'author'        => 'Klaus Heuer',
	...
	'constraints' => array(
		'depends' => array(
			'php' => '5.2.0-0.0.0',
			'typo3' => '4.5.dev-4.7.99',
			'extbase' => '4.5.0-6.1.99',
			'fluid' => '4.5.0-6.1.99',
		),
		'conflicts' => array(
		),
